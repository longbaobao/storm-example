...
public class ProvinceCityBatchMapper implements CqlRowMapper<List<String>, Number>, Serializable {
	private static final long serialVersionUID = -6135029143676707055L;

	public static final String KEYSPACE_NAME = "lambdasample";
	public static final String TABLE_NAME = "province_city_count_batch";
